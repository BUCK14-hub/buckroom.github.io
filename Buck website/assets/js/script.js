...
let messages = [
    ...
    'i\'m BUCK.',
    'i do lot of things:',
    'https://sellix.io/BUCK - My own shop in developpement.',
    'https://www.youtube.com/channel/UCYdjK1GNxzNYS6C-WG2pGlw - My youtube channel.',
    'a futur big project - Soon :).',
    'i have my own minecraft client (discord for more infos) - and... That it ;).',
    'Hope you like my future content on youtube',
    'feel free to contact me via discord @Pyrolia#8204.',
    'you can also send me an email via Shiruki.shop@gmail.com.'
];
...
function newText() {
    ...
    $('#contentinner').append(`<div class="instruction"> <span class="user">BUCK@133.0.0.3</span>: <span class="path">~</span>$ <span id="command${currentlyOn}" class="command"></span> <span class="blinking-cursor" id="blinkingcursor">_</span> </div>`);
